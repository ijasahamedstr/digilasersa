        ...
        >
          ...
          >
            ...
            <Grid item xs={12} md={5} sx={{ pl: { sm: "150px", xs: 0 } }}>
              ...
              >
                 التركيب ويمكنها تقديم معلومات مباشرة للعميل بطريقسهلةة مبتكرة. وعرض المحتوى بأكثر من طريقة .كما تتميز ببرنامج تشغيل سهل يحتوي على عدد كبير من تأثيرات الحركة تعرض جميع اللغات المكتوبة من جهاز الكمبيوتر مما يزيد فرص الاتصال والتواصل مع عملائك بشكل أفضل .
              </Typography>
            </Grid>
            <Box sx={{ position: "absolute", bottom: 0, left: 0, width: "30%", borderBottom: "2px solid #979a9a", display: { xs: "none", md: "block" } }} />
            <Box sx={{ position: "absolute", top: 0, right: 0, height: "18%", width: "18%", borderRight: "2px solid #979a9a", display: { xs: "none", md: "block" } }} />
