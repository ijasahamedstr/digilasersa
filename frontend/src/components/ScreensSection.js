...
import { Box, Typography, Grid, TextField, Button, useTheme, useMediaQuery, Container,Card,CardContent } from '@mui/material';
...
const ScreensSection = () => {
  ...
  return (
    <Container maxWidth={false} sx={{ padding: 0 }} style={{ paddingLeft: '0px', paddingRight: '0px', paddingTop: '100px' }}>
      ...
      <Container maxWidth={false} sx={{ padding: '0 80px' }}>
        <Grid container spacing={2} sx={{ marginTop: '40px',paddingLeft:'80px',paddingRight:'80px' }}>
        ...
        <Container maxWidth={false} sx={{ padding: 0,background:'#f5f5f5',paddingBottom:'20px'}}>
          <Grid container spacing={2} sx={{ marginTop: '40px',paddingLeft:'80px',paddingRight:'80px' }}>
     ...
     <Grid container spacing={2} sx={{ marginTop: '40px',paddingLeft:'80px',paddingRight:'80px' }}>
      ...
      <Container maxWidth={false} sx={{ padding: '0 80px',marginBottom:'80px'}}>
      <Grid container spacing={2} sx={{ marginTop: '40px',paddingLeft:'80px',paddingRight:'80px' }}>
      ...
      {/* Contact Section */}
      <section style={{ backgroundColor: '#000000', width: '100%', margin: '0 auto', display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: '50px', paddingBottom: '50px', marginTop: '-30px' }}>
        <Container maxWidth="xl" sx={{ paddingX: { xs: 2, sm: 3, md: 5 }, textAlign: 'center' }}>
          <Grid container spacing={4}>
            {/* Text Section on the Right */}
            <Grid item xs={12} sm={6} sx={{ direction: 'rtl' }}>
              <Typography variant="h4" color="white" paragraph>Contact Us</Typography>
              <Typography variant="h5" color="#00fffc">للطلب والإستفسار /</Typography>
            ...
            <Grid item xs={12} sm={6}>
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '10px', direction: 'rtl' }}>
                <TextField
                  label="الاسم"
                  variant="outlined"
                  fullWidth
