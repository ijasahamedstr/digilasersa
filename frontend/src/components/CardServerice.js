...
// Main component — no slider, responsive grid of up to 3 cards (LIFO)
function CardServerice() {
  const feedbacks = [
    {
      name: "م / محمد الجاسم",
      type: "image",
    ...
    },
    {
      ...
      stars: 5,
      text: " الليزر من أقدم الشركات للدعاية والإعلان",
    },
    {
    ...
    {
      name: " احد ممثلي جمعية المجدوعي الخيرية",
      type: "image",
      image: "https://i.ibb.co/prMbTnhZ/image.webp",
      stars: 5,
      text: "عمل ممتاز ورائع",
    },
  ];

  // last 3 items, reversed so last-in shows first (LIFO)
  const displayedFeedbacks = feedbacks.slice(-3).reverse();
